...
export function changes(before: Record<string, any> | undefined, after: Record<string, any> | undefined): Record<string, [any, any]> {
    ...
    for (const key of Object.keys(after ?? {})) if (before && !(key in before)) output[key] = [null, after![key]];
