        ...
        app
            ...
            .post(
                ...
                async ({ body, query: { id: input } }) => {
                    ...
                    const doc = await db.share_links.findOneAndUpdate({ content: body }, { $set: { content: body } });
                    ...
                    while (true) {
                        ...
                        const doc = await db.share_links.findOneAndUpdate({ id }, { $setOnInsert: { content: body } }, { upsert: true });
                        if (!doc) return { id };
                    }
                },
                {
